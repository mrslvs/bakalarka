...
const startCom = async () => {
    parser.on('data', (data) => {
        if (data == 1234) {
            console.log('got handshake, arduino is waiting for my confirmation for 3 seconds');
            return 'got handshake, arduino is waiting for my confirmation for 3 seconds';
